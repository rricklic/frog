...
func _unhandled_key_input(event: InputEvent) -> void:
	if (Input.is_action_just_pressed("ui_up")):
		...
		dialogue.text = "Hello, world! This is an example dialogue for testing. La la la la la la la la la la la la la la la la la la la la la la la la la la la la la la la la la la la la la"
